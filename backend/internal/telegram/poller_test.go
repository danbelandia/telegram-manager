...
func (f *fakeService) SendMessage(ctx context.Context, chatID int64, text string, disablePreview bool, keyboard *InlineKeyboardMarkup) (int64, error) {
	return 0, nil
}
func (f *fakeService) SendPhoto(ctx context.Context, chatID int64, photoURL, caption string, keyboard *InlineKeyboardMarkup) (int64, error) {
	return 0, nil
}
